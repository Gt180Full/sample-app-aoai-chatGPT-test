...
<Stack className={styles.chatEmptyState}>
    ...
    <h2 className={styles.chatEmptyStateSubtitle}>Ce chatbot est configuré pour répondre à vos questions</h2>
</Stack>
```
To update the logo, change `src={Azure}` to point to your own SVG file, which you can put in `frontend/src/assets`/
To update the headers, change the strings "Start chatting" and "Ce chatbot est configuré pour répondre à vos questions" to your desired values.
